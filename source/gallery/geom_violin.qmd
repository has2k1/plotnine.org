...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:41:57.899546Z', iopub.status.busy: '2024-03-05T15:41:57.899226Z', iopub.status.idle: '2024-03-05T15:41:58.587961Z', shell.execute_reply: '2024-03-05T15:41:58.587240Z'}
import pandas as pd
import numpy as np
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:41:58.591423Z', iopub.status.busy: '2024-03-05T15:41:58.591116Z', iopub.status.idle: '2024-03-05T15:41:58.604811Z', shell.execute_reply: '2024-03-05T15:41:58.604284Z'}
np.random.seed(123)
n = 20
mu = (1, 2.3)
sigma = (1, 1.6)
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:41:58.642924Z', iopub.status.busy: '2024-03-05T15:41:58.642681Z', iopub.status.idle: '2024-03-05T15:42:00.088818Z', shell.execute_reply: '2024-03-05T15:42:00.088231Z'}
(
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:42:00.092068Z', iopub.status.busy: '2024-03-05T15:42:00.091751Z', iopub.status.idle: '2024-03-05T15:42:00.376605Z', shell.execute_reply: '2024-03-05T15:42:00.375880Z'}
(
    ggplot(df, aes("when", "value"))
    + geom_violin(df)
    + geom_point()
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:42:00.380017Z', iopub.status.busy: '2024-03-05T15:42:00.379729Z', iopub.status.idle: '2024-03-05T15:42:00.663076Z', shell.execute_reply: '2024-03-05T15:42:00.662411Z'}
(
    ggplot(df, aes("when", "value"))
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:42:00.665895Z', iopub.status.busy: '2024-03-05T15:42:00.665660Z', iopub.status.idle: '2024-03-05T15:42:01.008306Z', shell.execute_reply: '2024-03-05T15:42:01.007774Z'}
(
    ggplot(df, aes("when", "value"))
    + geom_violin(df, style="left-right")  # changed
    + geom_point()
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:42:01.011326Z', iopub.status.busy: '2024-03-05T15:42:01.011100Z', iopub.status.idle: '2024-03-05T15:42:01.447216Z', shell.execute_reply: '2024-03-05T15:42:01.446708Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:42:01.450499Z', iopub.status.busy: '2024-03-05T15:42:01.450278Z', iopub.status.idle: '2024-03-05T15:42:01.869162Z', shell.execute_reply: '2024-03-05T15:42:01.868655Z'}
(
    ggplot(df, aes("when", "value"))
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T15:42:01.872524Z', iopub.status.busy: '2024-03-05T15:42:01.872082Z', iopub.status.idle: '2024-03-05T15:42:02.371079Z', shell.execute_reply: '2024-03-05T15:42:02.370565Z'}
