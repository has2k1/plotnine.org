...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:45.275784Z', iopub.status.busy: '2024-03-05T11:29:45.275424Z', iopub.status.idle: '2024-03-05T11:29:46.166659Z', shell.execute_reply: '2024-03-05T11:29:46.165750Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:46.170636Z', iopub.status.busy: '2024-03-05T11:29:46.170281Z', iopub.status.idle: '2024-03-05T11:29:46.303078Z', shell.execute_reply: '2024-03-05T11:29:46.301841Z'}
!head -n 20 "data/survey-social-media.csv"
```

```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:46.307487Z', iopub.status.busy: '2024-03-05T11:29:46.307147Z', iopub.status.idle: '2024-03-05T11:29:46.402357Z', shell.execute_reply: '2024-03-05T11:29:46.401782Z'}
columns = dict(
    COUNTRY="country",
    Q145="gender",
    Q146="age",
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:46.405496Z', iopub.status.busy: '2024-03-05T11:29:46.405242Z', iopub.status.idle: '2024-03-05T11:29:46.470504Z', shell.execute_reply: '2024-03-05T11:29:46.469836Z'}
yes_no = ["Yes", "No"]
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:46.474179Z', iopub.status.busy: '2024-03-05T11:29:46.473900Z', iopub.status.idle: '2024-03-05T11:29:46.495550Z', shell.execute_reply: '2024-03-05T11:29:46.494903Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:46.498945Z', iopub.status.busy: '2024-03-05T11:29:46.498669Z', iopub.status.idle: '2024-03-05T11:29:46.510323Z', shell.execute_reply: '2024-03-05T11:29:46.509430Z'}
segment_data = (
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:46.513933Z', iopub.status.busy: '2024-03-05T11:29:46.513670Z', iopub.status.idle: '2024-03-05T11:29:48.081266Z', shell.execute_reply: '2024-03-05T11:29:48.080476Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:29:48.084362Z', iopub.status.busy: '2024-03-05T11:29:48.084041Z', iopub.status.idle: '2024-03-05T11:29:49.112056Z', shell.execute_reply: '2024-03-05T11:29:49.111447Z'}
# Gallery, elaborate
