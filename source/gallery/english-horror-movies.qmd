---
title: "Analysis of Horror Movies"
author: "Deepali Kank"
jupyter: python3
...
For the contest submission, Deepali used _Corbel_, a proprietary font that aligns well with the theme of the plot.
Since _Corbel_ isn't freely available, we instead use a generic sans-serif font available on the system; most likely _Arial_, if it's installed.
