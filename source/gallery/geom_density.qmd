...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:44.323271Z', iopub.status.busy: '2024-03-05T11:28:44.322921Z', iopub.status.idle: '2024-03-05T11:28:45.020449Z', shell.execute_reply: '2024-03-05T11:28:45.019710Z'}
import pandas as pd
import numpy as np
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:45.023654Z', iopub.status.busy: '2024-03-05T11:28:45.023400Z', iopub.status.idle: '2024-03-05T11:28:45.037826Z', shell.execute_reply: '2024-03-05T11:28:45.037277Z'}
mpg.head()
```
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:45.079147Z', iopub.status.busy: '2024-03-05T11:28:45.078879Z', iopub.status.idle: '2024-03-05T11:28:46.992857Z', shell.execute_reply: '2024-03-05T11:28:46.991975Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:46.996500Z', iopub.status.busy: '2024-03-05T11:28:46.996123Z', iopub.status.idle: '2024-03-05T11:28:47.396950Z', shell.execute_reply: '2024-03-05T11:28:47.396365Z'}
# Gallery, distributions
(
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:47.399708Z', iopub.status.busy: '2024-03-05T11:28:47.399473Z', iopub.status.idle: '2024-03-05T11:28:47.868574Z', shell.execute_reply: '2024-03-05T11:28:47.868079Z'}
(
    ggplot(mpg, aes(x="cty", color="drv", fill="drv"))
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:47.871582Z', iopub.status.busy: '2024-03-05T11:28:47.871342Z', iopub.status.idle: '2024-03-05T11:28:48.423526Z', shell.execute_reply: '2024-03-05T11:28:48.422836Z'}
# Gallery, distributions
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:48.426773Z', iopub.status.busy: '2024-03-05T11:28:48.426546Z', iopub.status.idle: '2024-03-05T11:28:48.758871Z', shell.execute_reply: '2024-03-05T11:28:48.758163Z'}
n = 101
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:48.762126Z', iopub.status.busy: '2024-03-05T11:28:48.761898Z', iopub.status.idle: '2024-03-05T11:28:49.033526Z', shell.execute_reply: '2024-03-05T11:28:49.032936Z'}
region = (40, 60)
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:49.036282Z', iopub.status.busy: '2024-03-05T11:28:49.036007Z', iopub.status.idle: '2024-03-05T11:28:49.367075Z', shell.execute_reply: '2024-03-05T11:28:49.366329Z'}
region = (40, 60)
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:49.370121Z', iopub.status.busy: '2024-03-05T11:28:49.369861Z', iopub.status.idle: '2024-03-05T11:28:49.693684Z', shell.execute_reply: '2024-03-05T11:28:49.692991Z'}
# new class
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:49.696315Z', iopub.status.busy: '2024-03-05T11:28:49.696104Z', iopub.status.idle: '2024-03-05T11:28:49.997220Z', shell.execute_reply: '2024-03-05T11:28:49.996545Z'}
class geom_density_highlight(geom_density):
    # new method
...
```{python}
#| execution: {iopub.execute_input: '2024-03-05T11:28:49.999921Z', iopub.status.busy: '2024-03-05T11:28:49.999678Z', iopub.status.idle: '2024-03-05T11:28:50.309280Z', shell.execute_reply: '2024-03-05T11:28:50.308772Z'}
# Gallery, distributions
